...
mini_map = [
    ...
    [1,_,1,1,_,_,4,2,3,_,_,_,_,_,_,_,1,_,1],
    [1,_,_,_,_,_,1,_,3,_,_,4,4,_,1,_,_,_,1],
    [1,_,1,1,1,1,1,_,3,_,_,5,5,_,1,_,1,_,1],
    [1,_,_,_,_,_,_,_,_,_,_,5,_,_,1,1,1,_,1],
    [1,_,_,_,_,_,1,_,1,_,_,2,2,2,_,1,_,_,1],
